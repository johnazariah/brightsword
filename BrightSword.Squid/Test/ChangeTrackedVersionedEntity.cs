...
namespace BrightSword.Squid.Test
{
                                                ...
                                                ISampleInterface
    {
        ...
        public int IntegerValue
        {
            ...
            set
            {
                if (OnPropertyChanging("IntegerValue",
                                               typeof (int),
                                               _integerValue,
                                               value))
                {
        ...
        public long LongValue
        {
            ...
            set
            {
                if (OnPropertyChanging("LongValue",
                                               typeof (int),
                                               _longValue,
                                               value))
                {
        ...
        public short ShortValue
        {
            ...
            set
            {
                if (OnPropertyChanging("ShortValue",
                                               typeof (int),
                                               _shortValue,
                                               value))
                {
        ...
        public byte ByteValue
        {
            ...
            set
            {
                if (OnPropertyChanging("ByteValue",
                                               typeof (int),
                                               _byteValue,
                                               value))
                {
        ...
        public bool BoolValue
        {
            ...
            set
            {
                if (OnPropertyChanging("BoolValue",
                                               typeof (int),
                                               _boolValue,
                                               value))
                {
        ...
        public DateTime DateTimeValue
        {
            ...
            set
            {
                if (OnPropertyChanging("DateTimeValue",
                                               typeof (int),
                                               _dateTimeValue,
                                               value))
                {
        ...
        public string StringValue
        {
            ...
            set
            {
                if (OnPropertyChanging("StringValue",
                                               typeof (int),
                                               _stringValue,
                                               value))
                {
        ...
        public decimal MutableValue
        {
            ...
            set
            {
                if (OnPropertyChanging("MutableValue",
                                               typeof (decimal),
                                               _mutableValue,
                                               value))
                {
        ...
        string IBaseInterface.HiddenProperty
        {
            ...
            set
            {
                ...
                if (OnPropertyChanging("HiddenProperty",
                                               typeof (string),
                                               _mutableValue,
                                               value))
                {
